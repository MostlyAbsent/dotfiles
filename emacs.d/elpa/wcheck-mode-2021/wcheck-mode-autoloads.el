;;; wcheck-mode-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
This is used when language does not define a face." :group 'wcheck)
...
Move point forward to next marked text area." t nil)

(autoload 'wcheck-jump-backward "wcheck-mode" "\
Move point backward to previous marked text area." t nil)
...
(register-definition-prefixes "wcheck-mode" '("wcheck-"))

;;;***

;;;### (autoloads nil nil ("wcheck-mode-pkg.el") (0 0 0 0))
